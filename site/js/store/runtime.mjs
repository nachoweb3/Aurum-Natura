  ...
  return `
    <div class="header-shell">
      ...
      <div class="header-actions">
        ...
        <button type="button" class="cart-button" data-action="toggle-cart" aria-label="${app.copy.nav.cart}">
          <svg class="cart-button__icon" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
